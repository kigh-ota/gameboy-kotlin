...
class Emulator {
    ...
    private fun pushStack(addr: UShort) {
        SP--
        mem[SP.toInt()] = hi8(addr)
        SP--
        mem[SP.toInt()] = lo8(addr)
    }
    ...
    private fun get8(ref8: Ref8): UByte {
        return when (ref8) {
            ...
            Ref8.refDE -> refDE
            Ref8.n -> read8()
            Ref8.refNN -> mem[read16().toInt()]
            Ref8.refC -> mem[u16(0xFFu, C).toInt()]
            Ref8.refN -> mem[u16(0xFFu, read8()).toInt()]
        }
    }
    ...
    private fun set8(ref8: Ref8, value: UByte) {
        when (ref8) {
            ...
            Ref8.refNN -> mem[read16().toInt()] = value
            Ref8.refC -> mem[u16(0xFFu, C).toInt()] = value
            Ref8.refN -> mem[u16(0xFFu, read8()).toInt()] = value
        }
    }
